...
async function instagramstalk(username) {
  try {
    const { data } = await axios.get(
        ...
        username,
      {
        headers: {
          ...
          Cookie: {
            mid: "ZXH1hAALAAHZjU0tY1nHGCITNS65",
            ig_did: "24656E59-77D3-4A88-8FAB-B0B705B92909",
            ig_nrcb: "1",
            datr: "g_VxZQJA2tn8_n8GBuroAS2g",
            fbm_124024574287414: "base_domain=.instagram.com",
            ds_user_id: "64405676316",
            ps_n: "0",
            ps_l: "1",
            csrftoken: "nmwe3tcbN7fk2HYzwAJEXpxWWhmSPKNA",
            sessionid:
              "64405676316%3ArHSZ5bIM1sOwlA%3A0%3AAYdjUYy1plz6f1uivfXeiMzOIWcaa2BUoSAXtas3iw",
            fbsr_124024574287414:
              "HBCVyfAQF01e-5uN6GCOTD4F9-T0aZsxoWAGSaw9hdg.",
            rur: "EAG\05464405676316\0541739272188:01f79d20bbc58a57599ebc4259bb669b503dfe8b43a4486297f3a0d7b26d5870be7a148b",
          },
        },
      }
    );
    return data.status == "ok"
      ? {
          status: true,
          profile_picture_hd: data.data.user.profile_pic_url_hd,
          profile_picture_sd: data.data.user.profile_pic_url,
          data: {
      ...
      : { status: false, message: "user not found1" };
  } catch {
    const { data } = await axios.get(
      "https://i.instagram.com/api/v1/users/web_profile_info/?username=" +
        username,
    ...
    return data.status == "ok"
      ...
      : { status: false, message: "user not found2" };
  }
}
    ...
    axios
      .get("https://whoisjsonapi.com/v1/" + domain, {
        headers: {
          ...
          Authorization: `Bearer uZbv9VavOMQieKw9dyB0DCudF3Bib1_AmShwU7zMt9O-xaqWyp4QbFgDqP-KSCo`,
        },
      })
      .then((res) => {
        resolve(res.data);
